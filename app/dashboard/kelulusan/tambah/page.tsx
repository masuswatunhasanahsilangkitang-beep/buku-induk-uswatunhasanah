    ...
    async function fetchSantri() {
      try {
        ...
        if (json.success && json.data) {
          // Ambil spesifik array 'santri' dari dalam object data
          // (Kita gunakan fallback json.data jika sewaktu-waktu API-nya berubah lagi)
          setSantriList(json.data.santri ? json.data.santri : json.data);
        }
      } catch (error) {
